...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter RawData domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class RawData : RawDataBase, IEditableObject {
        ...
        public RawData(Int32 RawDataId) : base(RawDataId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a RawDatarecordset object.
        /// </summary>
        public RawData(RawDataRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(RawData sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public RawData(bool IsAddNew) : this(0) { 
            _IsAddNew = IsAddNew; 
        } 
