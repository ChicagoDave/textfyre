...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter Session domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class Session : SessionBase, IEditableObject {
        ...
        public Session(string SessionId) : base(SessionId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a Sessionrecordset object.
        /// </summary>
        public Session(SessionRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(Session sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public Session(bool IsAddNew) : this("") { 
            _IsAddNew = IsAddNew; 
        } 
