...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter SessionTransaction domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class SessionTransaction : SessionTransactionBase, IEditableObject {
        
        /// <summary>
        /// Empty default constructor.
        /// </summary>
        public SessionTransaction() : base() {
        }

        public SessionTransaction(string SessionId) : base(SessionId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a SessionTransactionrecordset object.
        /// </summary>
        public SessionTransaction(SessionTransactionRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(SessionTransaction sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public SessionTransaction(bool IsAddNew) : this("") { 
            _IsAddNew = IsAddNew; 
        } 
