...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter aspnet_SchemaVersions domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class aspnet_SchemaVersions : aspnet_SchemaVersionsBase, IEditableObject {
        
        /// <summary>
        /// Empty default constructor.
        /// </summary>
        public aspnet_SchemaVersions() : base() {
        }

        public aspnet_SchemaVersions(string Feature, string CompatibleSchemaVersion) : base(Feature, CompatibleSchemaVersion) {
		}        

        /// <summary>
        /// Empty constructor that accepts a aspnet_SchemaVersionsrecordset object.
        /// </summary>
        public aspnet_SchemaVersions(aspnet_SchemaVersionsRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(aspnet_SchemaVersions sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public aspnet_SchemaVersions(bool IsAddNew) : this("", "") { 
            _IsAddNew = IsAddNew; 
        } 
