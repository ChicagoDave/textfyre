...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter aspnet_Membership domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class aspnet_Membership : aspnet_MembershipBase, IEditableObject {
        ...
        public aspnet_Membership(Guid UserId) : base(UserId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a aspnet_Membershiprecordset object.
        /// </summary>
        public aspnet_Membership(aspnet_MembershipRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(aspnet_Membership sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public aspnet_Membership(bool IsAddNew) : this(Guid.NewGuid()) { 
            _IsAddNew = IsAddNew; 
        } 
