...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter Team domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class Team : TeamBase, IEditableObject {
        ...
        public Team(Int32 TeamId) : base(TeamId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a Teamrecordset object.
        /// </summary>
        public Team(TeamRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(Team sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public Team(bool IsAddNew) : this(0) { 
            _IsAddNew = IsAddNew; 
        } 
