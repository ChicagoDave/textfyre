...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter Student domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class Student : StudentBase, IEditableObject {
        ...
        /// <summary>
        /// Empty constructor that accepts a Studentrecordset object.
        /// </summary>
        public Student(StudentRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(Student sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public Student(bool IsAddNew) : this("") { 
            _IsAddNew = IsAddNew; 
        } 
