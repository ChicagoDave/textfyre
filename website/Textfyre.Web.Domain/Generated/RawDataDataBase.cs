...
namespace Textfyre.TextfyreWeb.DataLayer {
    ...
    /// <summary>
    /// Data Factory class that handles all database interaction for the RawData table.
    /// </summary>
    [Serializable()]
    public abstract class RawDataDataBase {
        ...
        /// <summary>
        /// Instance of the parameter factory class for the RawData table.
        /// </summary>
        private Textfyre.TextfyreWeb.DataLayer.RawDataParameterFactory _parameterFactory;
        ...
        /// </summary> 
        public RawDataDataBase() {
            GetDBControllers();
            GetCacheManager();
            _parameterFactory = new RawDataParameterFactory();
        }

        /// <summary>
        /// Protected property for the parameter factory.
        /// </summary>
        protected Textfyre.TextfyreWeb.DataLayer.RawDataParameterFactory ParameterFactory {
        ...
        /// </summary>
        public virtual List<Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset> GetAllRawData() {
            return ExecuteSqlGetCollection("SELECT [RawDataId], [RawData] FROM RawData", null);
        }

        /// <summary>
        /// Get a single record in the table.
        /// </summary>
        public virtual Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset GetRawDataById(Int32 RawDataId) {
            if (RawDataId < 1)
                return null;

            string sql = "SELECT [RawDataId], [RawData] FROM RawData WHERE [RawDataId] = @RawDataId";
            List<SqlParameter> parameters = new List<SqlParameter>();
            
			parameters.Add(ParameterFactory.GetParameter(RawDataFields.RawDataId, RawDataId));            
        ...
        /// </summary>
        public virtual Int32 InsertRawData(Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset record) {
            string sql = "INSERT INTO RawData([RawData]) VALUES (@RawData); SELECT SCOPE_IDENTITY() as ID;";
            List<SqlParameter> parameters = new List<SqlParameter>();

			if(record.RawData != null)
				parameters.Add(ParameterFactory.GetParameter(RawDataFields.RawData, record.RawData));
			else
				parameters.Add(ParameterFactory.GetParameter(RawDataFields.RawData, DBNull.Value));
        ...
        /// </summary>
        public virtual int UpdateRawData(Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset record) {
            string sql = "UPDATE RawData SET [RawData] = @RawData WHERE [RawDataId] = @RawDataId";
            List<SqlParameter> parameters = new List<SqlParameter>();

			parameters.Add(ParameterFactory.GetParameter(RawDataFields.RawDataId, record.RawDataId));
			if(record.RawData != null)
				parameters.Add(ParameterFactory.GetParameter(RawDataFields.RawData, record.RawData));
			else
				parameters.Add(ParameterFactory.GetParameter(RawDataFields.RawData, DBNull.Value));
        ...
        /// </summary>
        public virtual int DeleteRawData(Int32 RawDataId) {
            string sql = "DELETE FROM RawData WHERE [RawDataId] = @RawDataId";
            List<SqlParameter> parameters = new List<SqlParameter>();
        ...
        /// </summary>
        public Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset ExecuteQueryNameGetRecord(string QueryName, List<SqlParameter> Parameters) {
        ...
        /// </summary>
        public Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset ExecuteSqlGetRecord(string SqlText, List<SqlParameter> Parameters) {
        ...
        /// </summary>
        private Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset ExecuteGetRecord(string CmdText, List<SqlParameter> Parameters) {
            List<Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset> newRawDataRecordsetList = ExecuteReader(CmdText, Parameters, false);
            if(newRawDataRecordsetList.Count == 0)
                return null;

            return newRawDataRecordsetList[0];
        }        
        #endregion
        ...
        /// </summary>
        public List<Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset> ExecuteQueryNameGetCollection(string QueryName, List<SqlParameter> Parameters) {
        ...
        /// a strongly typed collection of recordsets.
        /// </summary>
        public List<Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset> ExecuteSqlGetCollection(string SqlText, List<SqlParameter> Parameters) {
        ...
        /// a strongly typed collection of recordsets.
        /// </summary>
        protected List<Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset> ExecuteSPGetCollection(string StoredProcedureName, List<SqlParameter> Parameters) {
        ...
        /// </summary> 
        /// <param name="drRawData"></param> 
        private List<Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset> LoadItems(SqlDataReader drRawData) {           

            List<Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset> newRawDataRecordsetList = new List<Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset>();
            bool namesMapped = false;
            Dictionary<string, int> fieldMap = null;

            // read through datareader, add items 
            while (drRawData.Read()) {

                if (!namesMapped) {
                    //Map field name to ordinal position
                    fieldMap = new Dictionary<string, int>();
                    for (int i = 0; i < drRawData.FieldCount; i++)
                        fieldMap.Add(drRawData.GetName(i), i);

                    namesMapped = true;
                }

                Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset newRawDataRecordset = new Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset();
                object o = null;

				if (fieldMap.ContainsKey("RawDataId")) {
					o = drRawData[fieldMap["RawDataId"]];
					if (o != DBNull.Value)
						newRawDataRecordset.RawDataId = (Int32)o;
				}

				if (fieldMap.ContainsKey("RawData")) {
					o = drRawData[fieldMap["RawData"]];
					if (o != DBNull.Value)
						newRawDataRecordset.RawData = ((string)o).Trim();
				}


                newRawDataRecordset.IsDirty = false;
                newRawDataRecordsetList.Add(newRawDataRecordset);
            }
            
            return newRawDataRecordsetList;
        }

        /// <summary>
        /// Private method that returns a List<T> of RawDataRecordset
        /// </summary>
        private List<Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset> ExecuteReader(string CmdText, List<SqlParameter> Parameters, bool isStoredProcedure) {
            SqlDataReader selectReader                                                           = null;
            List<Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset> newRawDataRecordsetList = null;
            ...
            if (_cacheManager != null) {
                ...
                if (_cacheManager.Exists2(cacheKey)) {
                    newRawDataRecordsetList = _cacheManager.Get2< List<Textfyre.TextfyreWeb.BusinessLayer.RawDataRecordset> >(cacheKey);
                }
            }

            if (newRawDataRecordsetList == null) {
                try {
                    if (!_mainDBController.HasTransaction)
                        _mainDBController.CurrentConnection.Open();
                    ...
                    newRawDataRecordsetList = LoadItems(selectReader);
                    sqlCmd.Parameters.Clear();
                } catch (SqlException sqlEx) {
                ...
                if (_cacheManager != null) {
                    _cacheManager.Set2(cacheKey, newRawDataRecordsetList, _cacheExpiration);
                }
            }
        ...
        private void LogSqlException(string methodName, SqlException sqlEx) {            
            if (sqlEx.Class >= 20) {
                Logger.LogMessage(typeof(RawDataDataBase).FullName, methodName, sqlEx,
        ...
        private void LogGenericException(string methodName, Exception ex) {
            Logger.LogMessage(typeof(RawDataDataBase).FullName, methodName, ex,
                              Severity.ERROR, LogLocation.ALL);
        }
