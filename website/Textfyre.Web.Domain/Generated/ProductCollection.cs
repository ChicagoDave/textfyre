...
namespace Textfyre.TextfyreWeb.BusinessLayer {
    ...
    public class ProductCollection : List<Textfyre.TextfyreWeb.BusinessLayer.Product> {
        ...
        public void Sort(Textfyre.TextfyreWeb.DataLayer.ProductFields sortField, SortDirection sortDirection)
        {
            switch (sortField)
            {
				case DataLayer.ProductFields.ItemId:
					if (sortDirection == SortDirection.Descending)
						Sort(Product.SortBy.ItemIdColumnDESC);
					else
						Sort(Product.SortBy.ItemIdColumnASC);
					break;
				case DataLayer.ProductFields.ItemNumber:
					if (sortDirection == SortDirection.Descending)
						Sort(Product.SortBy.ItemNumberColumnDESC);
					else
						Sort(Product.SortBy.ItemNumberColumnASC);
					break;
