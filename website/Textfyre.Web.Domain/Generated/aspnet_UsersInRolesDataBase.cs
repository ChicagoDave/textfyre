...
namespace Textfyre.TextfyreWeb.DataLayer {
    ...
    /// <summary>
    /// Data Factory class that handles all database interaction for the aspnet_UsersInRoles table.
    /// </summary>
    [Serializable()]
    public abstract class aspnet_UsersInRolesDataBase {
        ...
        /// <summary>
        /// Instance of the parameter factory class for the aspnet_UsersInRoles table.
        /// </summary>
        private Textfyre.TextfyreWeb.DataLayer.aspnet_UsersInRolesParameterFactory _parameterFactory;
        ...
        /// </summary> 
        public aspnet_UsersInRolesDataBase() {
            GetDBControllers();
            GetCacheManager();
            _parameterFactory = new aspnet_UsersInRolesParameterFactory();
        }

        /// <summary>
        /// Protected property for the parameter factory.
        /// </summary>
        protected Textfyre.TextfyreWeb.DataLayer.aspnet_UsersInRolesParameterFactory ParameterFactory {
        ...
        /// </summary>
        public virtual List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset> GetAllaspnet_UsersInRoles() {
            return ExecuteSqlGetCollection("SELECT [UserId], [RoleId] FROM aspnet_UsersInRoles", null);
        }

        /// <summary>
        /// Get a single record in the table.
        /// </summary>
        public virtual Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset Getaspnet_UsersInRolesById(Guid UserId, Guid RoleId) {
            if (UserId == Guid.Empty && RoleId == Guid.Empty)
                return null;

            string sql = "SELECT [UserId], [RoleId] FROM aspnet_UsersInRoles WHERE [UserId] = @UserId AND [RoleId] = @RoleId";
            List<SqlParameter> parameters = new List<SqlParameter>();
            
			parameters.Add(ParameterFactory.GetParameter(aspnet_UsersInRolesFields.UserId, UserId));
			parameters.Add(ParameterFactory.GetParameter(aspnet_UsersInRolesFields.RoleId, RoleId));
        ...
        /// </summary>
        public virtual int Insertaspnet_UsersInRoles(Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset record) {
            string sql = "INSERT INTO aspnet_UsersInRoles([UserId], [RoleId]) VALUES (@UserId, @RoleId)";
            List<SqlParameter> parameters = new List<SqlParameter>();

			parameters.Add(ParameterFactory.GetParameter(aspnet_UsersInRolesFields.UserId, record.UserId));
			parameters.Add(ParameterFactory.GetParameter(aspnet_UsersInRolesFields.RoleId, record.RoleId));
        ...
        /// </summary>
        public virtual int Updateaspnet_UsersInRoles(Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset record) {
            string sql = "UPDATE aspnet_UsersInRoles SE WHERE [UserId] = @UserId AND [RoleId] = @RoleId";
            List<SqlParameter> parameters = new List<SqlParameter>();
        ...
        /// </summary>
        public virtual int Deleteaspnet_UsersInRoles(Guid UserId, Guid RoleId) {
            string sql = "DELETE FROM aspnet_UsersInRoles WHERE [UserId] = @UserId AND [RoleId] = @RoleId";
            List<SqlParameter> parameters = new List<SqlParameter>();
        ...
        /// </summary>
        public Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset ExecuteQueryNameGetRecord(string QueryName, List<SqlParameter> Parameters) {
        ...
        /// </summary>
        public Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset ExecuteSqlGetRecord(string SqlText, List<SqlParameter> Parameters) {
        ...
        /// </summary>
        private Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset ExecuteGetRecord(string CmdText, List<SqlParameter> Parameters) {
            List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset> newaspnet_UsersInRolesRecordsetList = ExecuteReader(CmdText, Parameters, false);
            if(newaspnet_UsersInRolesRecordsetList.Count == 0)
                return null;

            return newaspnet_UsersInRolesRecordsetList[0];
        }        
        #endregion
        ...
        /// </summary>
        public List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset> ExecuteQueryNameGetCollection(string QueryName, List<SqlParameter> Parameters) {
        ...
        /// a strongly typed collection of recordsets.
        /// </summary>
        public List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset> ExecuteSqlGetCollection(string SqlText, List<SqlParameter> Parameters) {
        ...
        /// a strongly typed collection of recordsets.
        /// </summary>
        protected List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset> ExecuteSPGetCollection(string StoredProcedureName, List<SqlParameter> Parameters) {
        ...
        /// </summary> 
        /// <param name="draspnet_UsersInRoles"></param> 
        private List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset> LoadItems(SqlDataReader draspnet_UsersInRoles) {           

            List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset> newaspnet_UsersInRolesRecordsetList = new List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset>();
            bool namesMapped = false;
            Dictionary<string, int> fieldMap = null;

            // read through datareader, add items 
            while (draspnet_UsersInRoles.Read()) {

                if (!namesMapped) {
                    //Map field name to ordinal position
                    fieldMap = new Dictionary<string, int>();
                    for (int i = 0; i < draspnet_UsersInRoles.FieldCount; i++)
                        fieldMap.Add(draspnet_UsersInRoles.GetName(i), i);

                    namesMapped = true;
                }

                Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset newaspnet_UsersInRolesRecordset = new Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset();
                object o = null;

				if (fieldMap.ContainsKey("UserId")) {
					o = draspnet_UsersInRoles[fieldMap["UserId"]];
					if (o != DBNull.Value)
						newaspnet_UsersInRolesRecordset.UserId = (Guid)o;
				}

				if (fieldMap.ContainsKey("RoleId")) {
					o = draspnet_UsersInRoles[fieldMap["RoleId"]];
					if (o != DBNull.Value)
						newaspnet_UsersInRolesRecordset.RoleId = (Guid)o;
				}


                newaspnet_UsersInRolesRecordset.IsDirty = false;
                newaspnet_UsersInRolesRecordsetList.Add(newaspnet_UsersInRolesRecordset);
            }
            
            return newaspnet_UsersInRolesRecordsetList;
        }

        /// <summary>
        /// Private method that returns a List<T> of aspnet_UsersInRolesRecordset
        /// </summary>
        private List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset> ExecuteReader(string CmdText, List<SqlParameter> Parameters, bool isStoredProcedure) {
            SqlDataReader selectReader                                                           = null;
            List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset> newaspnet_UsersInRolesRecordsetList = null;
            ...
            if (_cacheManager != null) {
                ...
                if (_cacheManager.Exists2(cacheKey)) {
                    newaspnet_UsersInRolesRecordsetList = _cacheManager.Get2< List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_UsersInRolesRecordset> >(cacheKey);
                }
            }

            if (newaspnet_UsersInRolesRecordsetList == null) {
                try {
                    if (!_mainDBController.HasTransaction)
                        _mainDBController.CurrentConnection.Open();
                    ...
                    newaspnet_UsersInRolesRecordsetList = LoadItems(selectReader);
                    sqlCmd.Parameters.Clear();
                } catch (SqlException sqlEx) {
                ...
                if (_cacheManager != null) {
                    _cacheManager.Set2(cacheKey, newaspnet_UsersInRolesRecordsetList, _cacheExpiration);
                }
            }
        ...
        private void LogSqlException(string methodName, SqlException sqlEx) {            
            if (sqlEx.Class >= 20) {
                Logger.LogMessage(typeof(aspnet_UsersInRolesDataBase).FullName, methodName, sqlEx,
        ...
        private void LogGenericException(string methodName, Exception ex) {
            Logger.LogMessage(typeof(aspnet_UsersInRolesDataBase).FullName, methodName, ex,
                              Severity.ERROR, LogLocation.ALL);
        }
