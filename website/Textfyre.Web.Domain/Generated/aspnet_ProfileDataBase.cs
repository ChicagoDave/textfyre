...
namespace Textfyre.TextfyreWeb.DataLayer {
    ...
    /// <summary>
    /// Data Factory class that handles all database interaction for the aspnet_Profile table.
    /// </summary>
    [Serializable()]
    public abstract class aspnet_ProfileDataBase {
        ...
        /// <summary>
        /// Instance of the parameter factory class for the aspnet_Profile table.
        /// </summary>
        private Textfyre.TextfyreWeb.DataLayer.aspnet_ProfileParameterFactory _parameterFactory;
        ...
        /// </summary> 
        public aspnet_ProfileDataBase() {
            GetDBControllers();
            GetCacheManager();
            _parameterFactory = new aspnet_ProfileParameterFactory();
        }

        /// <summary>
        /// Protected property for the parameter factory.
        /// </summary>
        protected Textfyre.TextfyreWeb.DataLayer.aspnet_ProfileParameterFactory ParameterFactory {
        ...
        /// </summary>
        public virtual List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset> GetAllaspnet_Profile() {
            return ExecuteSqlGetCollection("SELECT [UserId], [PropertyNames], [PropertyValuesString], [PropertyValuesBinary], [LastUpdatedDate] FROM aspnet_Profile", null);
        }

        /// <summary>
        /// Get a single record in the table.
        /// </summary>
        public virtual Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset Getaspnet_ProfileById(Guid UserId) {
            if (UserId == Guid.Empty)
                return null;

            string sql = "SELECT [UserId], [PropertyNames], [PropertyValuesString], [PropertyValuesBinary], [LastUpdatedDate] FROM aspnet_Profile WHERE [UserId] = @UserId";
            List<SqlParameter> parameters = new List<SqlParameter>();
            
			parameters.Add(ParameterFactory.GetParameter(aspnet_ProfileFields.UserId, UserId));            
        ...
        /// </summary>
        public virtual Guid Insertaspnet_Profile(Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset record) {
            string sql = "INSERT INTO aspnet_Profile([PropertyNames], [PropertyValuesString], [PropertyValuesBinary], [LastUpdatedDate]) VALUES (@PropertyNames, @PropertyValuesString, @PropertyValuesBinary, @LastUpdatedDate); SELECT SCOPE_IDENTITY() as ID;";
            List<SqlParameter> parameters = new List<SqlParameter>();

			parameters.Add(ParameterFactory.GetParameter(aspnet_ProfileFields.PropertyNames, record.PropertyNames));

			parameters.Add(ParameterFactory.GetParameter(aspnet_ProfileFields.PropertyValuesString, record.PropertyValuesString));

			parameters.Add(ParameterFactory.GetParameter(aspnet_ProfileFields.PropertyValuesBinary, record.PropertyValuesBinary));

			parameters.Add(ParameterFactory.GetParameter(aspnet_ProfileFields.LastUpdatedDate, record.LastUpdatedDate));
        ...
        /// </summary>
        public virtual int Updateaspnet_Profile(Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset record) {
            string sql = "UPDATE aspnet_Profile SET [PropertyNames] = @PropertyNames, [PropertyValuesString] = @PropertyValuesString, [PropertyValuesBinary] = @PropertyValuesBinary, [LastUpdatedDate] = @LastUpdatedDate WHERE [UserId] = @UserId";
            List<SqlParameter> parameters = new List<SqlParameter>();

			parameters.Add(ParameterFactory.GetParameter(aspnet_ProfileFields.UserId, record.UserId));
			parameters.Add(ParameterFactory.GetParameter(aspnet_ProfileFields.PropertyNames, record.PropertyNames));
        ...
        /// </summary>
        public virtual int Deleteaspnet_Profile(Guid UserId) {
            string sql = "DELETE FROM aspnet_Profile WHERE [UserId] = @UserId";
            List<SqlParameter> parameters = new List<SqlParameter>();
        ...
        /// </summary>
        public Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset ExecuteQueryNameGetRecord(string QueryName, List<SqlParameter> Parameters) {
        ...
        /// </summary>
        public Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset ExecuteSqlGetRecord(string SqlText, List<SqlParameter> Parameters) {
        ...
        /// </summary>
        private Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset ExecuteGetRecord(string CmdText, List<SqlParameter> Parameters) {
            List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset> newaspnet_ProfileRecordsetList = ExecuteReader(CmdText, Parameters, false);
            if(newaspnet_ProfileRecordsetList.Count == 0)
                return null;

            return newaspnet_ProfileRecordsetList[0];
        }        
        #endregion
        ...
        /// </summary>
        public List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset> ExecuteQueryNameGetCollection(string QueryName, List<SqlParameter> Parameters) {
        ...
        /// a strongly typed collection of recordsets.
        /// </summary>
        public List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset> ExecuteSqlGetCollection(string SqlText, List<SqlParameter> Parameters) {
        ...
        /// a strongly typed collection of recordsets.
        /// </summary>
        protected List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset> ExecuteSPGetCollection(string StoredProcedureName, List<SqlParameter> Parameters) {
        ...
        /// </summary> 
        /// <param name="draspnet_Profile"></param> 
        private List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset> LoadItems(SqlDataReader draspnet_Profile) {           

            List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset> newaspnet_ProfileRecordsetList = new List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset>();
            bool namesMapped = false;
            Dictionary<string, int> fieldMap = null;

            // read through datareader, add items 
            while (draspnet_Profile.Read()) {

                if (!namesMapped) {
                    //Map field name to ordinal position
                    fieldMap = new Dictionary<string, int>();
                    for (int i = 0; i < draspnet_Profile.FieldCount; i++)
                        fieldMap.Add(draspnet_Profile.GetName(i), i);

                    namesMapped = true;
                }

                Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset newaspnet_ProfileRecordset = new Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset();
                object o = null;

				if (fieldMap.ContainsKey("UserId")) {
					o = draspnet_Profile[fieldMap["UserId"]];
					if (o != DBNull.Value)
						newaspnet_ProfileRecordset.UserId = (Guid)o;
				}

				if (fieldMap.ContainsKey("PropertyNames")) {
					o = draspnet_Profile[fieldMap["PropertyNames"]];
					if (o != DBNull.Value)
						newaspnet_ProfileRecordset.PropertyNames = ((string)o).Trim();
				}

				if (fieldMap.ContainsKey("PropertyValuesString")) {
					o = draspnet_Profile[fieldMap["PropertyValuesString"]];
					if (o != DBNull.Value)
						newaspnet_ProfileRecordset.PropertyValuesString = ((string)o).Trim();
				}

				if (fieldMap.ContainsKey("PropertyValuesBinary")) {
					o = draspnet_Profile[fieldMap["PropertyValuesBinary"]];
					if (o != DBNull.Value)
						newaspnet_ProfileRecordset.PropertyValuesBinary = (byte[])o;
				}

				if (fieldMap.ContainsKey("LastUpdatedDate")) {
					o = draspnet_Profile[fieldMap["LastUpdatedDate"]];
					if (o != DBNull.Value)
						newaspnet_ProfileRecordset.LastUpdatedDate = (DateTime)o;
				}


                newaspnet_ProfileRecordset.IsDirty = false;
                newaspnet_ProfileRecordsetList.Add(newaspnet_ProfileRecordset);
            }
            
            return newaspnet_ProfileRecordsetList;
        }

        /// <summary>
        /// Private method that returns a List<T> of aspnet_ProfileRecordset
        /// </summary>
        private List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset> ExecuteReader(string CmdText, List<SqlParameter> Parameters, bool isStoredProcedure) {
            SqlDataReader selectReader                                                           = null;
            List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset> newaspnet_ProfileRecordsetList = null;
            ...
            if (_cacheManager != null) {
                ...
                if (_cacheManager.Exists2(cacheKey)) {
                    newaspnet_ProfileRecordsetList = _cacheManager.Get2< List<Textfyre.TextfyreWeb.BusinessLayer.aspnet_ProfileRecordset> >(cacheKey);
                }
            }

            if (newaspnet_ProfileRecordsetList == null) {
                try {
                    if (!_mainDBController.HasTransaction)
                        _mainDBController.CurrentConnection.Open();
                    ...
                    newaspnet_ProfileRecordsetList = LoadItems(selectReader);
                    sqlCmd.Parameters.Clear();
                } catch (SqlException sqlEx) {
                ...
                if (_cacheManager != null) {
                    _cacheManager.Set2(cacheKey, newaspnet_ProfileRecordsetList, _cacheExpiration);
                }
            }
        ...
        private void LogSqlException(string methodName, SqlException sqlEx) {            
            if (sqlEx.Class >= 20) {
                Logger.LogMessage(typeof(aspnet_ProfileDataBase).FullName, methodName, sqlEx,
        ...
        private void LogGenericException(string methodName, Exception ex) {
            Logger.LogMessage(typeof(aspnet_ProfileDataBase).FullName, methodName, ex,
                              Severity.ERROR, LogLocation.ALL);
        }
