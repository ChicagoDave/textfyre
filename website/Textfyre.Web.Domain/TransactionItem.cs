...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter TransactionItem domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class TransactionItem : TransactionItemBase, IEditableObject {
        ...
        public TransactionItem(Int32 ItemId) : base(ItemId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a TransactionItemrecordset object.
        /// </summary>
        public TransactionItem(TransactionItemRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(TransactionItem sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public TransactionItem(bool IsAddNew) : this(0) { 
            _IsAddNew = IsAddNew; 
        } 
