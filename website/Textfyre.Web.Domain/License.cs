...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter License domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class License : LicenseBase, IEditableObject {
        ...
        public License(Int32 LicenseId) : base(LicenseId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a Licenserecordset object.
        /// </summary>
        public License(LicenseRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(License sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public License(bool IsAddNew) : this(0) { 
            _IsAddNew = IsAddNew; 
        } 
