...
namespace Textfyre.TextfyreWeb.DataLayer {
    ...
    public class aspnet_PersonalizationAllUsersData : Textfyre.TextfyreWeb.DataLayer.aspnet_PersonalizationAllUsersDataBase {
        /// <summary>
        /// Empty default constructor.
        /// </summary>
        public aspnet_PersonalizationAllUsersData() : base() {
        }
    }
}