...
namespace Textfyre.TextfyreWeb.DataLayer {
    ...
    public class aspnet_PersonalizationPerUserData : Textfyre.TextfyreWeb.DataLayer.aspnet_PersonalizationPerUserDataBase {
        /// <summary>
        /// Empty default constructor.
        /// </summary>
        public aspnet_PersonalizationPerUserData() : base() {
        }
    }
}