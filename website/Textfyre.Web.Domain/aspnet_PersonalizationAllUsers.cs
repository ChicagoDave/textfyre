...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter aspnet_PersonalizationAllUsers domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class aspnet_PersonalizationAllUsers : aspnet_PersonalizationAllUsersBase, IEditableObject {
        
        /// <summary>
        /// Empty default constructor.
        /// </summary>
        public aspnet_PersonalizationAllUsers() : base() {
        }

        public aspnet_PersonalizationAllUsers(Guid PathId) : base(PathId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a aspnet_PersonalizationAllUsersrecordset object.
        /// </summary>
        public aspnet_PersonalizationAllUsers(aspnet_PersonalizationAllUsersRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(aspnet_PersonalizationAllUsers sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public aspnet_PersonalizationAllUsers(bool IsAddNew) : this(Guid.NewGuid()) { 
            _IsAddNew = IsAddNew; 
        } 
