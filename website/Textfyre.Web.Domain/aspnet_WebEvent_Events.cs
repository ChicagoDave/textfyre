...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter aspnet_WebEvent_Events domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class aspnet_WebEvent_Events : aspnet_WebEvent_EventsBase, IEditableObject {
        
        /// <summary>
        /// Empty default constructor.
        /// </summary>
        public aspnet_WebEvent_Events() : base() {
        }

        public aspnet_WebEvent_Events(string EventId) : base(EventId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a aspnet_WebEvent_Eventsrecordset object.
        /// </summary>
        public aspnet_WebEvent_Events(aspnet_WebEvent_EventsRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(aspnet_WebEvent_Events sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public aspnet_WebEvent_Events(bool IsAddNew) : this("") { 
            _IsAddNew = IsAddNew; 
        } 
