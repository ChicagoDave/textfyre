...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter Group domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class Group : GroupBase, IEditableObject {
        ...
        public Group(Int32 GroupId) : base(GroupId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a Grouprecordset object.
        /// </summary>
        public Group(GroupRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(Group sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public Group(bool IsAddNew) : this(0) { 
            _IsAddNew = IsAddNew; 
        } 
