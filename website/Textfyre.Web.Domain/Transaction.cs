...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter Transaction domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class Transaction : TransactionBase, IEditableObject {
        ...
        public Transaction(Int32 TransactionId) : base(TransactionId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a Transactionrecordset object.
        /// </summary>
        public Transaction(TransactionRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(Transaction sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public Transaction(bool IsAddNew) : this(0) { 
            _IsAddNew = IsAddNew; 
        } 
