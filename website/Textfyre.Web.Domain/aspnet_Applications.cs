...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter aspnet_Applications domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class aspnet_Applications : aspnet_ApplicationsBase, IEditableObject {
        
        /// <summary>
        /// Empty default constructor.
        /// </summary>
        public aspnet_Applications() : base() {
        }

        public aspnet_Applications(Guid ApplicationId) : base(ApplicationId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a aspnet_Applicationsrecordset object.
        /// </summary>
        public aspnet_Applications(aspnet_ApplicationsRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(aspnet_Applications sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public aspnet_Applications(bool IsAddNew) : this(Guid.NewGuid()) { 
            _IsAddNew = IsAddNew; 
        } 
