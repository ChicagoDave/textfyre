...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter aspnet_PersonalizationPerUser domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class aspnet_PersonalizationPerUser : aspnet_PersonalizationPerUserBase, IEditableObject {
        
        /// <summary>
        /// Empty default constructor.
        /// </summary>
        public aspnet_PersonalizationPerUser() : base() {
        }

        public aspnet_PersonalizationPerUser(Guid Id) : base(Id) {
		}        

        /// <summary>
        /// Empty constructor that accepts a aspnet_PersonalizationPerUserrecordset object.
        /// </summary>
        public aspnet_PersonalizationPerUser(aspnet_PersonalizationPerUserRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(aspnet_PersonalizationPerUser sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public aspnet_PersonalizationPerUser(bool IsAddNew) : this(Guid.NewGuid()) { 
            _IsAddNew = IsAddNew; 
        } 
