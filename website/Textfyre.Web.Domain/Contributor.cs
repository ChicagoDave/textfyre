...
namespace Textfyre.TextfyreWeb.BusinessLayer { 
    ...
    /// <summary>
    /// Starter Contributor domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class Contributor : ContributorBase, IEditableObject {
        ...
        public Contributor(Int32 ContributorId) : base(ContributorId) {
		}        

        /// <summary>
        /// Empty constructor that accepts a Contributorrecordset object.
        /// </summary>
        public Contributor(ContributorRecordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(Contributor sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public Contributor(bool IsAddNew) : this(0) { 
            _IsAddNew = IsAddNew; 
        } 
