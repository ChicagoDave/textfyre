                ...
                <table width="100%" style="border-left: 1px black solid; border-right: 1px black solid;">
                    <tr>
                        <td style="padding-left: 10px; padding-top: 8px;">
                            <img alt="Jack Toresal and The Secret Letter" src="images/secret.jpg" />
                        </td>
                        ...
                        <td style="padding-left:5px;border-left:1px black solid;font-size:10pt;vertical-align:top;width:200px;">
                            Price: $24.95<br /><br />
                    ...
                    <tr>
                        <td style="padding-left: 10px; padding-top: 8px;">
                            <img alt="The Shadow in the Cathedral" src="images/shadow.jpg" />
                        </td>
                        <td style="vertical-align: top; padding-left: 10px; padding-right: 10px;">
                            Textfyre&#39;s second commercial Interactive Fiction game will be released on September
