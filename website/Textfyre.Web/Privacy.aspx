...
<div id="content-singleCol">
    ...
    <a name="1"></a><h2>Our Commitment To Privacy</h2>
    <p>
        ...
        <a name="2"></a><h2>The Information We Collect:</h2>
    <p>
        ...
        materials. The types of personal information collected at these pages are:</p>
        <ul>
            <li>First Name</li>
            
            <li>E-Mail Address</li>
         
            <li>City, State, School (optional for non-purchasers)</li>
       
            <li>Address, City, State, Zip, Country (purchasers only)</li>
        
            <li>We do NOT collect credit card or debit card information. We use PayPal and Google
            Checkout as our e-commerce partners and they have their own privacy policy regarding
            the information you give them.</li>
        
            <li>PayPal's privacy policy can be found at: <a style="text-decoration: underline;" href="https://www.paypal.com/us/cgi-bin/webscr?cmd=p/gen/ua/policy_privacy-outside"
                target="_blank">https://www.paypal.com/us/cgi-bin/webscr?cmd=p/gen/ua/policy_privacy-outside</a></li>
            <li>Google Checkout's privacy policy can be found at: <a style="text-decoration: underline;"
                href="https://checkout.google.com/files/privacy.html" target="_blank">https://checkout.google.com/files/privacy.html</a></li>
        </ul>
    

        <a name="3"></a><h2>The Way We Use Information:</h2>
    <p>
    ...
    <p>
        ...
        <a name="4"></a><h2>Our Commitment To Data Security</h2>
        <p>
            ...
            <a name="5"></a><h2>Our Commitment To Children's Privacy:</h2>
        <p>
            ...
            <a name="6"></a><h2>How You Can Access Or Correct Your Information</h2>
        <p>
        ...
        <p>
            ...
            <a name="7"></a><h2>How To Contact Us</h2>
        <p>
