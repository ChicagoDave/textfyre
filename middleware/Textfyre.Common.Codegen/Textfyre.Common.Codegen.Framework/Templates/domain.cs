...
namespace #rootNamespace#.BusinessLayer { 
    ...
    /// <summary>
    /// Starter #tableName# domain class. This class is only generated the first time and will not
    /// be over-written by the code generation tool.
    /// </summary>
    [Serializable()]
    public class #tableName# : #tableName#Base, IEditableObject {
        ...
        /// <summary>
        /// Empty constructor that accepts a #tableName#recordset object.
        /// </summary>
        public #tableName#(#tableName#Recordset Recordset) : base(Recordset) {
        }
        ...
        /// </summary>
        public delegate void CancelAddNewEventHandler(#tableName# sender, bool Remove);
        
        /// <summary>
        /// IEditableObject: New object constructor.
        /// </summary>
        public #tableName#(bool IsAddNew) : this(#generatedArgs#) { 
            _IsAddNew = IsAddNew; 
        } 
