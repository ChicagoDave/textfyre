...
/*! \brief Represents above-VM logic for running a TextFyre game.
    ...
    This is the first class in the fyrevm-foundation codebase which isn't a direct port of a Windows FyreVM class. It's meant to wrap up the logic that is above the level of the virtual machine (TFEngine) but still shared between all the Apple platforms: Mac, iPhone, and iPad.
 */
