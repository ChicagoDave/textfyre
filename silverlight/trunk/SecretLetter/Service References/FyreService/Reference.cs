...
// 
namespace SecretLetter.FyreService {
    ...
    public interface FyreServiceSoap {
        ...
        System.IAsyncResult BeginLogCommand(SecretLetter.FyreService.LogCommandRequest request, System.AsyncCallback callback, object asyncState);
        
        SecretLetter.FyreService.LogCommandResponse EndLogCommand(System.IAsyncResult result);
        
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://textfyre.com/LogNotes", ReplyAction="*")]
        System.IAsyncResult BeginLogNotes(SecretLetter.FyreService.LogNotesRequest request, System.AsyncCallback callback, object asyncState);
        
        SecretLetter.FyreService.LogNotesResponse EndLogNotes(System.IAsyncResult result);
    }
    ...
    public partial class LogCommandRequest {
        ...
        public SecretLetter.FyreService.LogCommandRequestBody Body;
        
        public LogCommandRequest() {
        }
        
        public LogCommandRequest(SecretLetter.FyreService.LogCommandRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class LogCommandResponse {
        ...
        public SecretLetter.FyreService.LogCommandResponseBody Body;
        
        public LogCommandResponse() {
        }
        
        public LogCommandResponse(SecretLetter.FyreService.LogCommandResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class LogNotesRequest {
        ...
        public SecretLetter.FyreService.LogNotesRequestBody Body;
        
        public LogNotesRequest() {
        }
        
        public LogNotesRequest(SecretLetter.FyreService.LogNotesRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class LogNotesResponse {
        ...
        public SecretLetter.FyreService.LogNotesResponseBody Body;
        
        public LogNotesResponse() {
        }
        
        public LogNotesResponse(SecretLetter.FyreService.LogNotesResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface FyreServiceSoapChannel : SecretLetter.FyreService.FyreServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class FyreServiceSoapClient : System.ServiceModel.ClientBase<SecretLetter.FyreService.FyreServiceSoap>, SecretLetter.FyreService.FyreServiceSoap {
        ...
        System.IAsyncResult SecretLetter.FyreService.FyreServiceSoap.BeginLogCommand(SecretLetter.FyreService.LogCommandRequest request, System.AsyncCallback callback, object asyncState) {
        ...
        private System.IAsyncResult BeginLogCommand(int storyId, string sessionId, int turn, string location, string school, string gender, int age, string city, string state, string commandText, string responseText, System.AsyncCallback callback, object asyncState) {
            SecretLetter.FyreService.LogCommandRequest inValue = new SecretLetter.FyreService.LogCommandRequest();
            inValue.Body = new SecretLetter.FyreService.LogCommandRequestBody();
            ...
            return ((SecretLetter.FyreService.FyreServiceSoap)(this)).BeginLogCommand(inValue, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SecretLetter.FyreService.LogCommandResponse SecretLetter.FyreService.FyreServiceSoap.EndLogCommand(System.IAsyncResult result) {
            return base.Channel.EndLogCommand(result);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        private void EndLogCommand(System.IAsyncResult result) {
            SecretLetter.FyreService.LogCommandResponse retVal = ((SecretLetter.FyreService.FyreServiceSoap)(this)).EndLogCommand(result);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SecretLetter.FyreService.FyreServiceSoap.BeginLogNotes(SecretLetter.FyreService.LogNotesRequest request, System.AsyncCallback callback, object asyncState) {
        ...
        private System.IAsyncResult BeginLogNotes(int storyId, string sessionId, int turn, string location, string school, string gender, int age, string city, string state, string notes, string notesBy, System.AsyncCallback callback, object asyncState) {
            SecretLetter.FyreService.LogNotesRequest inValue = new SecretLetter.FyreService.LogNotesRequest();
            inValue.Body = new SecretLetter.FyreService.LogNotesRequestBody();
            inValue.Body.storyId = storyId;
            inValue.Body.sessionId = sessionId;
            inValue.Body.turn = turn;
            inValue.Body.location = location;
            ...
            return ((SecretLetter.FyreService.FyreServiceSoap)(this)).BeginLogNotes(inValue, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SecretLetter.FyreService.LogNotesResponse SecretLetter.FyreService.FyreServiceSoap.EndLogNotes(System.IAsyncResult result) {
            return base.Channel.EndLogNotes(result);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        private void EndLogNotes(System.IAsyncResult result) {
            SecretLetter.FyreService.LogNotesResponse retVal = ((SecretLetter.FyreService.FyreServiceSoap)(this)).EndLogNotes(result);
        }
        ...
        protected override SecretLetter.FyreService.FyreServiceSoap CreateChannel() {
            return new FyreServiceSoapClientChannel(this);
        }
        
        private class FyreServiceSoapClientChannel : ChannelBase<SecretLetter.FyreService.FyreServiceSoap>, SecretLetter.FyreService.FyreServiceSoap {
            
            public FyreServiceSoapClientChannel(System.ServiceModel.ClientBase<SecretLetter.FyreService.FyreServiceSoap> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginLogCommand(SecretLetter.FyreService.LogCommandRequest request, System.AsyncCallback callback, object asyncState) {
            ...
            public SecretLetter.FyreService.LogCommandResponse EndLogCommand(System.IAsyncResult result) {
                object[] _args = new object[0];
                SecretLetter.FyreService.LogCommandResponse _result = ((SecretLetter.FyreService.LogCommandResponse)(base.EndInvoke("LogCommand", _args, result)));
                return _result;
            }
            
            public System.IAsyncResult BeginLogNotes(SecretLetter.FyreService.LogNotesRequest request, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[1];
                _args[0] = request;
            ...
            public SecretLetter.FyreService.LogNotesResponse EndLogNotes(System.IAsyncResult result) {
                object[] _args = new object[0];
                SecretLetter.FyreService.LogNotesResponse _result = ((SecretLetter.FyreService.LogNotesResponse)(base.EndInvoke("LogNotes", _args, result)));
                return _result;
            }
        }
    }
